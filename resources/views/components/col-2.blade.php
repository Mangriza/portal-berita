...
<div class="row g-4">
    <div class="col-12">
        <a href="#" class="w-100 rounded btn btn-primary d-flex align-items-center p-3 mb-2">
            ...
            <span class="text-white">Kingsriza</span>
        </a>
        <a href="github.com/mangriza" class="w-100 rounded btn btn-danger d-flex align-items-center p-3 mb-4">
            <i class="fab fa-github btn btn-light btn-square rounded-circle me-3"></i>
            <span class="text-white">M Riza buccharelli</span>
        </a>
    </div>
</div>
